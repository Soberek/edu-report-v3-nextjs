...
export const getMaterialsByType = (type: string) => 
  EDUCATIONAL_MATERIALS.filter(material => material.type === type);

export const getMaterialsByCategory = (category: string) => 
  EDUCATIONAL_MATERIALS.filter(material => material.category === category);

export const getMaterialById = (id: string) => 
  EDUCATIONAL_MATERIALS.find(material => material.id === id);
