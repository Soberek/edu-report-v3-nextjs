...
} from "@/app/(protected)/szkoly-w-programie/types/szkoly-w-programie.types";
import {
...
} from "@/app/(protected)/szkoly-w-programie/utils/szkoly-w-programie.utils";
import { getErrorMessage, normalizeStudentCount } from "@/app/(protected)/szkoly-w-programie/utils/error-handler.utils";
